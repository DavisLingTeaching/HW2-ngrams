...
def testPerplexity():
    ...
    try: 
        model.perplexity('the cat was reading the book', {})
    except NotImplementedError:
        sys.stderr.write('You need to implement the perplexity function\n')
        sys.exit(1)



    assert round(model.perplexity('the cat was reading the book', {}), 5) == 16256135.93056
